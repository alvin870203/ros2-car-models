...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('gazebo_control_config', default_value='prius_ackermann_gazebo_control.xacro',
                          description='The file name of the gazebo_control config, by default is prius_ackermann_gazebo_control.xacro'),
]
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("description"), "urdf", "prius.urdf.xacro"]
            ),
            " ",
            "use_ros2_control:=",
            use_ros2_control,
